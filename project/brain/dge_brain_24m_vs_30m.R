...
# Combine
count_data = merge(b24m_counts, b30m_counts, by = "GeneID", all = TRUE)
# Set 'GeneID' as row names
rownames(count_data) <- count_data$GeneID

# Create count matrix
counts_matrix <- count_data[, c("Counts1_24", "Counts2_24", "Counts3_24", "Counts1_30", "Counts2_30", "Counts3_30")]
counts_matrix
...
# Export to CSV file 
write.csv(as.data.frame(top_degs), file="Documents/ucsc_bme/BME237_RNA_bioinformatics/project/brain/dge_brain_24m_vs_30m.csv")
